...
#define _nstates1	23	/* observateur */
#define minseq1	52
#define maxseq1	73
#define _endstate1	22

#define _nstates0	53	/* feu */
#define minseq0	0
#define maxseq0	51
#define _endstate0	52
...
#define Pobservateur	((P1 *)this)
typedef struct P1 { /* observateur */
...
#define Air1	(sizeof(P1) - Offsetof(P1, courant) - 1*sizeof(uchar))
